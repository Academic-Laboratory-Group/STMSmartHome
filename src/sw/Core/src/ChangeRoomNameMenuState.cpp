		...
		State(stateManager), m_room(room), m_newName(room->getName())
{
	...
	m_guiBuilder.addTextBox(100, 25, "New name:", 24u, TEXT_COLOR, BACKGROUND_COLOR, 200, 50);
	m_guiBuilder.addTextBox(340, 40, m_newName, 24u, TEXT_COLOR, BACKGROUND_COLOR, 280, 80);
