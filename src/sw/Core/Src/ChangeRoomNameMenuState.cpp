...
ChangeRoomNameMenuState::ChangeRoomNameMenuState(StateManager* stateManager) : State(stateManager)
{
...
void ChangeRoomNameMenuState::processInput()
{
}
